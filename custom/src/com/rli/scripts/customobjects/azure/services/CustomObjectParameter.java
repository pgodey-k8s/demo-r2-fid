...
import com.rli.scripts.customobjects.azure.dto.GroupInfo;
...
public class CustomObjectParameter {
	/**
	 ...
	 */
	private static String stsUrl = null;
	...
	/**
	 * This arraylist would hold the list of verified domain names
	 * for this tenant.
	 */
	 ...
	 */
	public static final String ACCEPT_HEADER_VALUE = "application/json;odata=verbose";
	...
	public static void setUserPerPage(int userPerPage) {
		CustomObjectParameter.userPerPage = userPerPage;
	}
	...
	public static void setAccessToken(String accessToken) {
		CustomObjectParameter.accessToken = accessToken;
	}
	...
	public static void setDataContractVersion(String dataContractVersion) {
		CustomObjectParameter.dataContractVersion = dataContractVersion;
	}
	...
	public static void setTenantDomainName(String tenantDomainName) {
		CustomObjectParameter.tenantDomainName = tenantDomainName;
	}
	...
	public static void setRestServiceHost(String restServiceHost) {
		CustomObjectParameter.restServiceHost = restServiceHost;
	}
	...
	public static void setProtectedResourceHostName(
		...
		CustomObjectParameter.protectedResourceHostName = protectedResourceHostName;
	}
	...
	public static void setAppPrincipalId(String appPrincipalId) {
		CustomObjectParameter.appPrincipalId = appPrincipalId;
	}
	...
	public static void setAcsPrincipalId(String acsPrincipalId) {
		CustomObjectParameter.acsPrincipalId = acsPrincipalId;
	}
	...
	public static void setSymmetricKey(String symmetricKey) {
		CustomObjectParameter.symmetricKey = symmetricKey;
	}
	...
	public static void setTenantContextId(String tenantContextId) {
		CustomObjectParameter.tenantContextId = tenantContextId;
	}
	...
	public static void setStsUrl(String stsUrl) {
		CustomObjectParameter.stsUrl = stsUrl;
	}
	...
	public static void setProtectedResourcePrincipalId(
		...
		CustomObjectParameter.protectedResourcePrincipalId = protectedResourcePrincipalId;
	}
